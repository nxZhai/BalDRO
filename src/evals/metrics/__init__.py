...
from evals.metrics.utility import classifier_prob, hm_aggregate
...
# aggregate metrics
_register_metric(hm_aggregate_inverted)
_register_metric(forget_success)
